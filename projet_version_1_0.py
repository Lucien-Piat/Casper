...
def savant_jeu(fantome,savant):
    if fantome==savant:
        print(" ---------------------------------------------------")
        print("|               TELEPORTATION -1 PINTE              |")
        print("|                                                   |")
        print("|        Vous avez rencontré le Savant-fou          |")
        print("|                                                   |")
        print(" ---------------------------------------------------")
        input('\nAppuyer sur une touche\n> ')
...
def bib_jeu(fantome, bc):
    if fantome in bc:
        print(" ---------------------------------------------------")
        print("|                OH NON ! -2 PINTES                 |")
        print("|                                                   |")
        print("|        Vous avez rencontré un Bibbendum           |")
        print("|                                                   |")
        print(" ---------------------------------------------------")
        input('\nAppuyer sur une touche\n>')
        return -2
...
def perdu(pinte): 
    if pinte < 1 : 
        ...
        print("|                      PERDU                        |")
        print("|                                                   |")
        print("|            Vous n'avez plus de pintes             |")
        print("|                                                   |")
